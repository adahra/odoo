...
class CreateAppointment(models.TransientModel):
    ...
    def print_report(self):
        ...
        # # print("Data", data)
        return self.env.ref('aar_hospital.report_appointment').with_context(landscape=True).report_action(self, data=data)
    ...
    def create_appointment(self):
        ...
        new_appointment = self.env['aar_hospital.appointment'].create(vals)
        context = dict(self.env.context)
        context['form_view_initial_mode'] = 'edit'
        return {'type': 'ir.actions.act_window',
                'view_type': 'form',
                'view_mode': 'form',
                'res_model': 'aar_hospital.appointment',
    ...
    def get_data(self):
        appointments = self.env['aar_hospital.appointment'].search([])
